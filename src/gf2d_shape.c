...
Uint8 gf2d_edge_circle_intersection_poc_old(ShapeEdge e, ShapeCircle c, Vector2D *poc, Vector2D *normal);
Uint8 gf2d_edge_to_circle_intersection_poc(ShapeEdge e, ShapeCircle c, Vector2D *poc, Vector2D *normal);
Uint8 gf2d_circle_to_edge_intersection_poc(ShapeEdge e, ShapeCircle c, Vector2D *poc, Vector2D *normal);

Vector2D gf2d_rect_get_center_point(ShapeRect r)
{
	return vector2d(r.x + r.w*0.5, r.y + r.h*0.5);
}

Vector2D gf2d_edge_get_normal_for_rect(ShapeEdge e, ShapeRect r)
{
	Vector2D out = { 0 };
	Vector2D c = { 0 };
...
Vector2D gf2d_rect_get_normal_for_edge(ShapeRect r, ShapeEdge e)
{
	Vector2D out = { 0 };
	Vector2D c = { 0 };
	Vector2D n1, n2, p1, p2;
...
Vector2D gf2d_circle_get_normal_for_rect(ShapeCircle c, ShapeRect r)
{
	Vector2D out = { 0 };
	Vector2D poc = { 0 };
...
Vector2D gf2d_rect_get_normal_for_rect(ShapeRect r, ShapeRect ref)
{
	Vector2D out = { 0 };
	if (ref.x + 1 >= (r.x + r.w))
	{
...
Vector2D gf2d_rect_get_normal_for_cirlce(ShapeRect r, ShapeCircle c)
{
	Vector2D out = { 0 };
	if (c.x < r.x)out.x = -1;
	if (c.y < r.y)out.y = -1;
...
Vector2D gf2d_circle_get_normal_for_cirlce(ShapeCircle c, ShapeCircle c2)
{
	Vector2D out = { 0 };
...
Vector2D gf2d_edge_get_normal_for_cirlce(ShapeEdge e, ShapeCircle c)
{
	Vector2D out = { 0 };
	Vector2D dir = { 0 };
	Vector2D p1, p2;
...
Vector2D gf2d_edge_get_normal_for_edge(ShapeEdge e1, ShapeEdge e2)
{
	Vector2D out = { 0 };
...
Vector2D gf2d_shape_get_normal_for_edge(Shape s, ShapeEdge e)
{
	Vector2D out = { 0 };
	switch (s.type)
	{
...
Vector2D gf2d_shape_get_normal_for_cirlce(Shape s, ShapeCircle c)
{
	Vector2D out = { 0 };
	switch (s.type)
	{
...
Vector2D gf2d_shape_get_normal_for_rect(Shape s, ShapeRect r)
{
	Vector2D out = { 0 };
	switch (s.type)
	{
...
Vector4D gf2d_rect_to_vector4d(ShapeRect r)
{
...
void gf2d_rect_draw(ShapeRect r, Color color)
{
	gf2d_draw_rect(gf2d_rect_to_sdl_rect(r), gfc_color_to_vector4(color));
}

void gf2d_rect_draw_filled(ShapeRect r, Color color)
{
...
Shape gf2d_shape_from_edge(ShapeEdge e)
{
	Shape shape;
	shape.type = ST_EDGE;
...
Uint8 gf2d_edge_intersect(ShapeEdge a, ShapeEdge b)
{
	return gf2d_edge_intersect_poc(a, b, NULL, NULL);
}

ShapeEdge gf2d_edge(float x1, float y1, float x2, float y2)
{
	ShapeEdge e;
...
ShapeEdge gf2d_edge_from_vectors(Vector2D a, Vector2D b)
{
	ShapeEdge e;
...
Uint8 gf2d_rect_to_intersection_poc(ShapeEdge e, ShapeRect r, Vector2D *poc, Vector2D *normal)
{
	Uint8 ret;
	Uint8 i;
...
Uint8 gf2d_edge_rect_intersection_poc(ShapeEdge e, ShapeRect r, Vector2D *poc, Vector2D *normal)
{
	Uint8 ret = 0;
	Uint8 i;
	Vector2D contacts[4] = { 0 };
...
Uint8 gf2d_edge_rect_intersection(ShapeEdge e, ShapeRect r)
{
	return gf2d_edge_rect_intersection_poc(e, r, NULL, NULL);
}

Uint8 gf2d_edge_intersect_shape(ShapeEdge e, Shape s)
{
	return gf2d_shape_overlap(gf2d_shape_from_edge(e), s);
}

Uint8 gf2d_edge_intersect_shape_poc(ShapeEdge e, Shape s, Vector2D *poc, Vector2D *normal)
{
...
Uint8 gf2d_edge_circle_intersection(ShapeEdge e, ShapeCircle c)
{
	Vector2D dir = { 0 };
	Vector2D p1, p2;
	Vector2D n1, n2;
...
void gf2d_edge_slog(ShapeEdge e)
{
...
ShapeRect gf2d_edge_get_bounds(ShapeEdge e)
{
	ShapeRect r;
	r.x = MIN(e.x1, e.x2);
	r.y = MIN(e.y1, e.y2);
